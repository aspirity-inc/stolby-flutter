  ...
  group(
    ...
    () {
      blocTest(
        ...
        act: (MapBloc bloc) => bloc.add(
          const MapEvent.rockMarkerPut(0),
        ),
        expect: () => [
          MapState.initial().copyWith(
            rocks: [
      ...
      blocTest(
        ...
        act: (MapBloc bloc) => bloc.add(
          const MapEvent.rockMarkerPut(-1),
        ),
        expect: () => [],
      );
    },
  ...
  group(
    ...
    () {
      blocTest(
        ...
        act: (MapBloc bloc) => bloc.add(
          const MapEvent.clickedRockRemoved(),
        ),
        expect: () => [
          MapState.initial().copyWith(
            rocks: [
