...
class MockISettingsRepository extends _i1.Mock
  ...
  @override
  _i4.Future<void> toggleAutoTheme({bool? value}) => (super.noSuchMethod(
      Invocation.method(#toggleAutoTheme, [], {#value: value}),
      returnValue: Future<void>.value(),
      returnValueForMissingStub: Future<void>.value()) as _i4.Future<void>);
  @override
  _i4.Future<void> toggleDarkTheme({bool? value}) => (super.noSuchMethod(
      Invocation.method(#toggleDarkTheme, [], {#value: value}),
      returnValue: Future<void>.value(),
      returnValueForMissingStub: Future<void>.value()) as _i4.Future<void>);
  @override
  _i4.Future<void> toggleMapReverse({bool? value}) => (super.noSuchMethod(
      Invocation.method(#toggleMapReverse, [], {#value: value}),
      returnValue: Future<void>.value(),
      returnValueForMissingStub: Future<void>.value()) as _i4.Future<void>);
  @override
  _i4.Future<void> toggleUserCentering({bool? value}) => (super.noSuchMethod(
      Invocation.method(#toggleUserCentering, [], {#value: value}),
      returnValue: Future<void>.value(),
      returnValueForMissingStub: Future<void>.value()) as _i4.Future<void>);
  @override
  _i4.Future<void> toggleGeolocation({bool? value}) => (super.noSuchMethod(
      Invocation.method(#toggleGeolocation, [], {#value: value}),
      returnValue: Future<void>.value(),
      returnValueForMissingStub: Future<void>.value()) as _i4.Future<void>);
  @override
