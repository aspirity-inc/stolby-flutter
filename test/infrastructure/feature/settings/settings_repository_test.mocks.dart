...
class MockSharedPreferencesService extends _i1.Mock
  ...
  _i3.Future<void> setGeolocationEnabled({bool? geolocationEnabled}) =>
      (super.noSuchMethod(
          Invocation.method(#setGeolocationEnabled, [],
  ...
  bool getReversedMap({bool? defaultValue}) => (super.noSuchMethod(
      ...
      returnValue: false) as bool);
  @override
  _i3.Future<void> setReversedMap({bool? reversedMap}) => (super.noSuchMethod(
      Invocation.method(#setReversedMap, [], {#reversedMap: reversedMap}),
      returnValue: Future<void>.value(),
      returnValueForMissingStub: Future<void>.value()) as _i3.Future<void>);
  @override
  bool getMapUserCentering({bool? defaultValue}) => (super.noSuchMethod(
      ...
      returnValue: false) as bool);
  @override
  _i3.Future<void> setMapUserCentering({bool? mapUserCentering}) =>
      (super.noSuchMethod(
          Invocation.method(
              #setMapUserCentering, [], {#mapUserCentering: mapUserCentering}),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i3.Future<void>);
  @override
  bool getAutoThemeChange({bool? defaultValue}) => (super.noSuchMethod(
      ...
      returnValue: false) as bool);
  @override
  _i3.Future<void> setAutoThemeChange({bool? autoThemeChange}) =>
      (super.noSuchMethod(
          Invocation.method(
              #setAutoThemeChange, [], {#autoThemeChange: autoThemeChange}),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i3.Future<void>);
  @override
  bool getLightTheme({bool? defaultValue}) => (super.noSuchMethod(
      ...
      returnValue: false) as bool);
  @override
  _i3.Future<void> setLightTheme({bool? lightTheme}) => (super.noSuchMethod(
      Invocation.method(#setLightTheme, [], {#lightTheme: lightTheme}),
      returnValue: Future<void>.value(),
      returnValueForMissingStub: Future<void>.value()) as _i3.Future<void>);
  @override
