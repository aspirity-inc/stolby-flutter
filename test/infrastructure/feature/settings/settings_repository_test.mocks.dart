...
class MockSharedPreferencesService extends _i1.Mock
  ...
  @override
  _i3.Future<void> setGeolocationEnabled({required bool? geolocationEnabled}) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i3.Future<void> setReversedMap({required bool? reversedMap}) =>
      (super.noSuchMethod(
        Invocation.method(
          #setReversedMap,
          [],
  ...
  @override
  _i3.Future<void> setMapUserCentering({required bool? mapUserCentering}) =>
      (super.noSuchMethod(
        Invocation.method(
          #setMapUserCentering,
          [],
  ...
  @override
  _i3.Future<void> setAutoThemeChange({required bool? autoThemeChange}) =>
      (super.noSuchMethod(
        Invocation.method(
          #setAutoThemeChange,
          [],
  ...
  @override
  _i3.Future<void> setLightTheme({required bool? lightTheme}) =>
      (super.noSuchMethod(
        Invocation.method(
          #setLightTheme,
          [],
  ...
  @override
  bool getOnboardingVisited() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i3.Future<void> setOnboardingVisited() => (super.noSuchMethod(
        Invocation.method(
